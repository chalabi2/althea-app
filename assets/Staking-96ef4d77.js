import{T as q,a as J,b as R,c as j}from"./TabPanel-5bae7227.js";import{l as P,S as X,a as $}from"./selected-9b5ead79.js";import{n as y,a as i,j as t,T as h,Y as W,am as Z,D as p,B as A,aF as ee,u,a3 as te,aI as he,H as k,aa as D,aJ as ge,aK as pe,ap as fe,a9 as be,as as xe,F as K,U as O,aL as ae,W as re,P as G,p as L,k as w,h as Q,a4 as ye,z as U,az as ve,Z as H,V as we,aC as ke}from"./index-349b3f63.js";import{s as oe,T as Ne}from"./LMTables-22758e70.js";import{h as Ce}from"./moment-9d68d5ae.js";import{t as Ee,a as Se,b as Ae,c as _e,g as ne,d as Ie,e as Te,f as De,h as Re,i as je,j as ze}from"./transactionHelpers-d26162be.js";import{T as ie,u as le,O as Le}from"./ongoingTxModal-77162024.js";import{H as Ve}from"./seo-8c33d248.js";import"./down-5990fce4.js";const Me=({totalStaked:e,rewards:a,apr:r,onRewards:s,canClaim:c})=>i(Fe,{children:[i("div",{className:"dual-item",style:{margin:"0"},children:[t("div",{className:"top",children:t(h,{type:"title",size:"text1",children:"total staked"})}),t("div",{className:"bottom",children:t(h,{type:"title",children:e})})]}),t("div",{className:"separator"}),i("div",{className:"dual-item",children:[t("div",{className:"top",children:t(h,{type:"title",size:"text1",children:"apr"})}),t("div",{className:"bottom",children:i(h,{type:"title",children:[r,"%"]})})]}),t("div",{className:"separator"}),i("div",{className:"dual-item",children:[t("div",{className:"top",children:t(h,{type:"title",size:"text1",children:"rewards"})}),t("div",{className:"bottom",children:t(h,{type:"title",children:a})})]}),t(W,{height:"big",disabled:Number(a)==0||!c,onClick:()=>{s()},children:t(h,{size:"text2",type:"text",bold:!0,children:"claim rewards"})})]}),Fe=y.div`
  display: flex;
...
`;var _=(e=>(e.DELEGATE="DELEGATE",e.UNDELEGATE="UNDELEGATE",e.REDELEGATE="REDELEGATE",e.CLAIM_REWARDS="CLAIM_REWARDS",e))(_||{});const Ue={validator:{commission:{commission_rates:{max_change_rate:"0",max_rate:"0",rate:"0"},update_time:"0"},consensus_pubkey:{"@type":"0",key:"0"},delegator_shares:"0",description:{details:"0",identity:"0",moniker:"0",security_contact:"0",website:"0"},jailed:!1,min_self_delegation:"0",operator_address:"0",status:"0",tokens:"0",unbonding_height:"0",unbonding_time:"0"},userDelegations:void 0,undelagatingInfo:void 0};var I=(e=>(e[e.STAKE=0]="STAKE",e[e.CLAIM_REWARDS=1]="CLAIM_REWARDS",e[e.NONE=2]="NONE",e))(I||{});const Y=Z(e=>({currentModal:2,open:a=>e({currentModal:a}),close:()=>e({currentModal:2}),activeValidator:Ue,setActiveValidator:a=>e({activeValidator:a})})),Be="/assets/rightArrow-189f42f9.svg",Pe="/assets/arrow-4cafc986.svg",Oe=y.table`
  .jailed {
    color: #ef4444;
    &::after {
      content: url(${Pe});
...
`,ct=e=>{const a=Y(),r=le(),s=H();return p.useEffect(()=>{a.currentModal!=I.NONE&&O.events.stakingActions.modalInteraction(a.activeValidator.validator.description.moniker,!0)},[a.currentModal]),i(st,{open:a.currentModal!=I.NONE,onClose:()=>{a.close(),O.events.stakingActions.modalInteraction(a.activeValidator.validator.description.moniker,!1)},lockScroll:!0,modal:!0,position:"center center",nested:!0,children:[t("div",{role:"button",tabIndex:0,onClick:a.close,children:t("img",{src:we,style:{position:"absolute",top:".5rem",right:".5rem",cursor:"pointer",zIndex:"3",padding:".5rem"},alt:"close"})}),t(Le,{onClose:a.close}),a.currentModal===I.STAKE&&t(it,{validator:a.activeValidator,allValidators:e.allValidators,balance:s.balance,account:s.account,txFeeCheck:e.txBalanceChecks,txStore:r,chainId:Number(s.chainId)})]})},dt=()=>{const e=Y(),a=H(),r=le(),[s,c]=p.useState([]),[o,n]=p.useState("0"),[l,m]=p.useState([]),[f,v]=p.useState({total_unbonding:A.from("0")}),[b,C]=p.useState(A.from("0"));async function x(){e.open(I.CLAIM_REWARDS),rt(r,Number(a.chainId),a.account??"",z)}async function T(){a.account&&(m(await Ie(w(Number(a.chainId)),a.account)),C(await Te(w(Number(a.chainId)),a.account)),v(await De(w(Number(a.chainId)),a.account))),c(await Re(w(Number(a.chainId)))),n(await je(w(Number(a.chainId))))}p.useEffect(()=>{const g=setInterval(async()=>{await T()},6e3);return()=>clearInterval(g)},[a.account]),p.useEffect(()=>{T()},[a.account]);const E=ne(s,l,f),M=E.filter(g=>!!g.undelagatingInfo),z=E.filter(g=>!!g.userDelegations);function S(g,d){return A.from(g.amount).add(g.gas).add(d??0)}function N(g,d){return g.gt(d)}return{validators:s,delegations:l,undelegations:f,userValidators:z,undelagatingValidators:M,handleClaimRewards:x,rewards:b,stakingApr:o,txFeeCheck:(()=>{const g=a.balance;return{claimRewards:N(g,S(ue)),delegate:N(g,S(V,u.parseEther("1"))),redelegate:N(g,S(et)),undelegate:N(g,S(me))}})()}},vt=()=>{const e=H(),a=de(),[r,s]=p.useState(!1),{validators:c,delegations:o,undelegations:n,userValidators:l,undelagatingValidators:m,handleClaimRewards:f,rewards:v,stakingApr:b,txFeeCheck:C}=dt();return i(K,{children:[t(Ve,{title:"Althea - Staking",description:"Stake your ALTG tokens to participate in governance",link:"staking"}),i(Xe,{children:[t(ct,{allValidators:c,txBalanceChecks:C}),i(q,{className:"tabs",children:[i(J,{className:"tablist",children:[t(R,{className:r?"tab tab-hover":"tab",onMouseEnter:()=>{s(!0)},onMouseLeave:()=>{s(!1)},onClick:()=>{a.setInAllValidators(!1)},children:"my staking"}),t(R,{className:r?"tab tab-hover":"tab",onClick:()=>{a.setInAllValidators(!0)},onMouseEnter:()=>{s(!0)},onMouseLeave:()=>{s(!1)},children:"all validators"}),i("div",{className:"sort-search",style:{width:"100%",justifyContent:"flex-end",alignItems:"center",gap:"12px",display:a.inAllValidators?"flex":"none"},children:[t(X,{style:{width:"10rem"},children:t($,{className:"react-select-container",styles:{dropdownIndicator:x=>({...x,color:"var(--primary-color)"})},classNamePrefix:"react-select",options:[{label:"active",value:1},{label:"inactive",value:2},{label:"all",value:3}],onChange:x=>{a.setValidatorSort((x==null?void 0:x.value)??1)},defaultValue:{label:"active",value:1},isSearchable:!1,placeholder:"active"})}),t(ae,{style:{textAlign:"left",paddingRight:"1rem"},value:a.searchQuery,onChange:x=>a.setSearchQuery(x.target.value),placeholder:"search..."})]})]}),t(j,{children:t(Ke,{onRewards:f,connected:ke(Number(e.chainId)),account:e.account??"",balance:e.balance,totalStaked:ze(o),totalUnbonding:n.total_unbonding,totalRewards:v,apr:b,userValidationInfo:l,undelegationValidators:m,canClaim:C.claimRewards})}),t(j,{children:t(qe,{validators:ne(c,o,n)})})]})]})]})};export{vt as default};
