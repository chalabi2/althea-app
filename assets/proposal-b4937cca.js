import{a as d,e as E,b as A,d as z,f as W,V as P,q as Q,P as I,c as k}from"./Styled-d274b8f6.js";import{n as C,D as h,a,j as e,b5 as Z,V as J,T as b,P as U,b6 as S,H as u,u as m,i as O,B as j,b7 as K,b8 as X,b9 as tt,ba as et,bb as ot,f as at,bc as rt,m as nt,_ as st,bd as it,U as lt,F as V,ab as ct,a4 as dt}from"./index-3a80e83a.js";import{j as ut,d as ht}from"./transactionHelpers-b64fdc4c.js";import{T as pt,u as mt,O as gt}from"./ongoingTxModal-f9ab8956.js";import"./moment-9d68d5ae.js";const T={quorum:"33.4%",threshold:"50%",veto:"33.4%"},vt=C.div`
...
`,bt=({proposal:t,currentVote:i,onVote:c,onClose:r})=>{const[o,n]=h.useState(i??d.NONE),s=l=>{n(l)};return a(vt,{children:[e("div",{className:"close",children:e(Z,{src:J,alt:"close",height:30,onClick:r})}),a(b,{type:"title",size:"title3",children:["your vote for #",t.proposal_id]}),e(b,{color:"white",children:t.content.title}),a("div",{className:"grp",children:[e(x,{selected:o===d.YES,voteOption:d.YES,name:"yes",onChange:s}),e(x,{selected:o===d.NO,voteOption:d.NO,name:"no",onChange:s}),e(x,{selected:o===d.VETO,voteOption:d.VETO,name:"veto",onChange:s}),e(x,{selected:o===d.ABSTAIN,voteOption:d.ABSTAIN,name:"abstain",onChange:s})]}),e(U,{style:{marginTop:"1rem"},onClick:()=>c(o),filled:!0,children:"vote"})]})},ft=C.div`
  padding: 2rem;
...
`,x=t=>a(ft,{className:t.selected?"active":"",onClick:()=>{t.onChange(t.voteOption)},children:[e("div",{className:"unchecked",children:e("div",{className:t.selected?"checked":""})}),e("p",{style:{marginLeft:"1rem"},children:t.name})]}),yt=t=>a(Nt,{...t,children:[a("div",{className:"votes",children:[e(S,{content:a(b,{children:[u(t.yes.toString()).toString(),'% votes casted for "YES"']}),trigger:e("div",{className:"yes bar",children:a("p",{children:[u(t.yes.toString()).toString(),"%"]})})}),e(S,{content:a(b,{children:[u(t.no.toString()).toString(),"% of validators voted no."]}),trigger:e("div",{className:"no bar"})}),e(S,{content:a(b,{children:[u(t.veto.toString()).toString(),"% of validators voted veto."]}),trigger:e("div",{className:"veto bar"})}),e(S,{content:a(b,{children:[u(t.abstain.toString()).toString(),"% of validators voted abstain."]}),trigger:e("div",{className:"abstain bar"})})]}),e("div",{className:"empty bar"}),e(S,{content:e(b,{children:t.quorum+"% quorum"}),trigger:e("div",{className:"quorum dashed"})})]}),Nt=C.div`
  width: 100%;
  height: 50px;
