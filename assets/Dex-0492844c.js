import{n as E,D as T,j as t,a as l,T as S,d as ue,b as Le,ad as C,ae as I,ar as O,B as h,ak as Ee,as as Pe,H as g,z as De,a3 as ne,u as y,P as v,F as G,at as J,X as Re,g as te,au as fe,C as M,av as q,aw as _,M as Oe,E as H,m as W,ax as Me,U as ee,G as Ue,ay as ve,az as he,aA as be,aB as pe,a4 as _e,aC as Be,Y as Fe,aD as se,aE as ae,aF as He}from"./index-942959e7.js";import{n as ze,g as K,a as Ve,b as qe,c as je,d as Ye,v as V,e as U,T as le,f as $e,_ as ge,h as Qe,i as We,j as Ke,u as Ze,k as Xe}from"./handleOnGoingTransactions-f55ff880.js";import{_ as Q,T as ye,O as Ge,u as re,g as Je}from"./ongoingTxModal-ddab4ea6.js";import{H as et}from"./seo-8560fa4b.js";import{s as ie}from"./LMTables-36f2731e.js";import"./down-f11b2b90.js";const X=e=>{const[n,o]=T.useState(!1);return t("div",{style:{overflowX:"auto"},children:l(tt,{children:[t("thead",{children:t("tr",{children:e.columns.map((r,a)=>t("th",{style:{backgroundColor:n&&a==e.columnClicked?"rgba(0, 119, 255, 0.25)":""},onClick:()=>{e.onColumnClicked&&e.onColumnClicked(a),o(!0)},children:r},r))})}),t("tbody",{children:e.children})]})})},tt=E.table`
  margin: 5px auto;
  max-width: 1200px;
  width: 100%;
...
`,Lt=e=>{const[n,o,r,a,c]=Ie(d=>[d.modalType,d.activePair,d.confirmationValues,d.setModalType,d.setConfirmationValues]);function u(d){switch(d){case L.ADD:return"Add Liquidity";case L.REMOVE:return"Remove Liquidity";case L.ADD_OR_REMOVE:return"Liquidity";default:return"Confirmation"}}return T.useEffect(()=>{n!==L.NONE&&ee.events.lpInterfaceActions.modalInteraction(n,o.basePairInfo.token1.symbol+" / "+o.basePairInfo.token2.symbol,!0)},[n]),l(Ue,{open:n!=L.NONE,title:e.txStore.modalOpen?"":u(n),onClose:()=>{ee.events.lpInterfaceActions.modalInteraction(n,o.basePairInfo.token1.symbol+" / "+o.basePairInfo.token2.symbol,!1),e.onClose()},children:[t(Ge,{onClose:e.onClose}),n===L.ADD&&t(pt,{onClose:e.onClose,activePair:o,setModalType:a,setConfirmationValues:c}),n===L.REMOVE&&t(gt,{onClose:e.onClose,activePair:o,setModalType:a,setConfirmationValues:c}),n===L.ADD_OR_REMOVE&&t(yt,{onClose:e.onClose,activePair:o,setModalType:a}),n===L.REMOVE_CONFIRM&&t(Tt,{onClose:e.onClose,activePair:o,chainId:e.chainId,account:e.account,confirmValues:r,txStore:e.txStore}),n===L.ADD_CONFIRM&&t(At,{onClose:e.onClose,activePair:o,chainId:e.chainId,account:e.account,confirmValues:r,txStore:e.txStore})]})},Et=e=>{const n=_(e).Router,o=new M(n,q),r=ke(e),a=ve(e),c=r.map(m=>{const i=new M(m.address,H),p=x=>{for(const[,k]of Object.entries(a))if(k.underlying.address==x)return k.address;return""};return[{contract:i,method:"totalSupply",args:[]},{contract:o,method:"getReserves",args:[m.token1.address,m.token2.address,m.stable]},{contract:o,method:"getUnderlyingPrice",args:[p(m.token1.address)]},{contract:o,method:"getUnderlyingPrice",args:[p(m.token2.address)]},{contract:o,method:"getUnderlyingPrice",args:[m.cLPaddress]}]}),u=he(r?c.flat():[],{chainId:be(e)?e:ue.chainId})??{},d=r?u.length/r.length:0;let f;const b=(m,i)=>{const p=m.map(k=>k==null?void 0:k.value),x=[];for(let k=0;k<m.length;k+=i)x.push(p.slice(k,k+i));return x};return r?d>0&&pe(u)?(f=b(u,d),f.map((m,i)=>{const p=m[0][0],x=m[1],k=x.reserveA,w=x.reserveB,[s,A]=We(k,w),N=m[2][0],P=m[3][0],F=m[4][0],Z=F.mul(p).div(h.from(10).pow(18));return{basePairInfo:r[i],totalSupply:{totalLP:p,tvl:Z,token1:k,token2:w,ratio:{aTob:A,ratio:s}},prices:{token1:N,token2:P,LP:F}}})):[]:[]},Pt=(e,n,o)=>{const r=_(o).Router,a=new M(r,q),c=_e(n)??h.from(0),u=e.map(i=>{const p=new M(i.basePairInfo.address,H),x=new M(i.basePairInfo.token1.address,H),k=new M(i.basePairInfo.token2.address,H),w=new M(i.basePairInfo.cLPaddress,Be);return[{contract:p,method:"balanceOf",args:[n]},{contract:x,method:"balanceOf",args:[n]},{contract:k,method:"balanceOf",args:[n]},{contract:x,method:"allowance",args:[n,a.address]},{contract:k,method:"allowance",args:[n,a.address]},{contract:p,method:"allowance",args:[n,a.address]},{contract:w,method:"balanceOf",args:[n]},{contract:w,method:"exchangeRateStored",args:[]}]}),d=he(e&&be(o)&&n?u.flat():[])??{},f=e?d.length/e.length:0;let b;const m=(i,p)=>{const x=i.map(w=>w==null?void 0:w.value),k=[];for(let w=0;w<i.length;w+=p)k.push(x.slice(w,w+p));return k};return f>0&&pe(d)?(b=m(d,f),b.map((i,p)=>{const x=i[0][0],[k,w]=kt(e[p].basePairInfo,o),s=k?c:i[1][0],A=w?c:i[2][0],N=Ke(i[6][0],i[7][0]),P=Number(y.formatUnits(x.add(N).mul(h.from(10).pow(18)).div(e[p].totalSupply.totalLP))),F=x.mul(h.from(10).pow(18)).div(e[p].totalSupply.totalLP),Z=F.mul(e[p].totalSupply.token1).div(h.from(10).pow(18)),oe=F.mul(e[p].totalSupply.token2).div(h.from(10).pow(18)),Te=i[3][0],Ae=i[4][0],Ce=i[5][0];return{...e[p],userSupply:{totalLP:x,token1:Z,token2:oe,percentOwned:P},allowance:{token1:Te,token2:Ae,LPtoken:Ce},balances:{token1:s,token2:A}}})):e.map(i=>({...i,userSupply:{totalLP:h.from(0),token1:h.from(0),token2:h.from(0),percentOwned:0},allowance:{token1:h.from(0),token2:h.from(0),LPtoken:h.from(0)},balances:{token1:h.from(0),token2:h.from(0)}}))},Ft=()=>{const e=Fe(),n=re(),{notifications:o}=Ze(),[r,a]=T.useState([]);Xe(o,r,a);const[c,u]=Ie(s=>[s.setModalType,s.setActivePair]),d=Et(Number(e.chainId)),f=Pt(d,e.account,Number(e.chainId)),[b,m]=T.useState(0),[i,p]=T.useState(0),x=(f==null?void 0:f.filter(s=>!s.userSupply.totalLP.isZero()||s.userSupply.percentOwned>0).length)>0,k=(f==null?void 0:f.filter(s=>s.userSupply.totalLP.isZero()&&s.userSupply.percentOwned==0).length)>0,w=re().transactions.filter(s=>s.details.status==="Mining");return l(G,{children:[t(et,{title:"Althea - LP interface",description:"Althea Homepage serves De-fi applications",link:"lp"}),l(Dt,{as:se,children:[t("div",{children:t(Lt,{chainId:Number(e.chainId),account:e.account,onClose:()=>{c(L.NONE)},txStore:n})}),t("div",{style:{margin:"2rem 0"},children:l(S,{type:"title",color:"white",children:["to swap tokens, visit"," ",t("a",{onClick:()=>ee.events.lpInterfaceActions.visitSlingshot(),style:{color:"#a2fca3",textDecoration:"underline",fontFamily:"Macan"},href:"https://app.slingshot.finance/trade/",target:"_blank",rel:"noreferrer",children:"Slingshot"})]})}),w.length>0&&t("div",{className:"tables",children:t("div",{className:"left",children:t(X,{columns:["ongoing transactions"],children:w.map(s=>{var A;return t(st,{icons:((A=s.details.extra)==null?void 0:A.icon)??"",name:s.details.currentMessage??"",status:Je(s.details.status),date:new Date},s.details.txId)})})})}),x&&l("div",{children:[t(S,{type:"title",align:"left",className:"tableName",children:"current position"}),t(se,{children:t(X,{columns:["Asset","TVL","wallet","% Share"],onColumnClicked:s=>m(s),columnClicked:b,children:f==null?void 0:f.map((s,A)=>!s.userSupply.totalLP.isZero()||s.userSupply.percentOwned>0?t(de,{delay:.2*A,iconLeft:s.basePairInfo.token1.icon,iconRight:s.basePairInfo.token2.icon,onClick:()=>{u(s),c(s.userSupply.totalLP.isZero()?L.ADD:L.ADD_OR_REMOVE)},assetName:s.basePairInfo.token1.symbol+"/"+s.basePairInfo.token2.symbol,totalValueLocked:J+ae(g(y.formatUnits(s.totalSupply.tvl))),position:g(y.formatUnits(s.userSupply.totalLP,s.basePairInfo.decimals))+" LP Tokens",share:g((s.userSupply.percentOwned*100).toString()),sortableProps:[s.basePairInfo.token1.symbol+"/"+s.basePairInfo.token2.symbol,Number(y.formatUnits(s.totalSupply.tvl)),Number(y.formatUnits(s.userSupply.totalLP,s.basePairInfo.decimals)),s.userSupply.percentOwned]},s.basePairInfo.address):null).sort((s,A)=>{var N,P;return ie((N=s==null?void 0:s.props.sortableProps)==null?void 0:N[b],(P=A==null?void 0:A.props.sortableProps)==null?void 0:P[b])})})})]}),k?l("div",{children:[t(S,{type:"title",align:"left",className:"tableName",children:"pools"}),t(X,{columns:["Asset","TVL","wallet","% Share"],onColumnClicked:s=>p(s),columnClicked:i,children:f==null?void 0:f.map((s,A)=>s.userSupply.totalLP.isZero()&&s.userSupply.percentOwned==0?t(de,{delay:.1*A,iconLeft:s.basePairInfo.token1.icon,iconRight:s.basePairInfo.token2.icon,onClick:()=>{u(s),c(Number(s.userSupply.totalLP)>0?L.ADD_OR_REMOVE:L.ADD)},assetName:s.basePairInfo.token1.symbol+"/"+s.basePairInfo.token2.symbol,totalValueLocked:ae(g(y.formatUnits(s.totalSupply.tvl))),position:g(y.formatUnits(s.userSupply.totalLP))+" LP Tokens",share:g((s.userSupply.percentOwned*100).toString()),sortableProps:[s.basePairInfo.token1.symbol+"/"+s.basePairInfo.token2.symbol,Number(y.formatUnits(s.totalSupply.tvl)),Number(y.formatUnits(s.userSupply.totalLP,s.basePairInfo.decimals)),s.userSupply.percentOwned]},s.basePairInfo.address):null).sort((s,A)=>{var N,P;return ie((N=s==null?void 0:s.props.sortableProps)==null?void 0:N[i],(P=A==null?void 0:A.props.sortableProps)==null?void 0:P[i])})})]}):t("div",{style:{height:"30rem"},children:t(He,{})})]})]})},Dt=E.div`
  display: flex;
  flex-direction: column;
  min-height: 100%;
  .tableName {
